...
import shutil
#from pybossa.plugins.quiz.models import user_score
...
def task_presenter_editor(short_name):
    ...
    apiKey = str(current_user.api_key)
    pro = pro_features()
    ...
    if project.info.get('task_presenter'):
        ...
        tmpl = render_template(tmpl_uri, project=project,myApiKey=apiKey)
...
def update(short_name):
    ...
    def handle_valid_form(form):
        ...
        return redirect_content_type(url_for('file_test.upload_task',
